...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FirebaseFirestoreSwift-iOS/FirebaseFirestoreSwift.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ScrollCounter/ScrollCounter.framework"
