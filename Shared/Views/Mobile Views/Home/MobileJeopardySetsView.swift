//
//  MobileJeopardySetsView.swift
//  Trivio! (iOS)
//
//  Created by David Chen on 11/27/22.
//

import Foundation
import SwiftUI

struct MobileJeopardySetsView: View {
            ...
            ScrollView(.horizontal, showsIndicators: false) {
                HStack {
                    ...
                    ForEach(gamesVM.gamePreviews, id: \.self) { jeopardySetPreview in
                        MobileJeopardySetCellView(jeopardySetPreview: jeopardySetPreview)
                    }
                    Spacer(minLength: 15)
                }
            }
...
struct MobileJeopardySetCellView: View {
    @EnvironmentObject var formatter: MasterHandler
